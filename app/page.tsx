...
function MateriasChart() {
  ...
  const materias = [
    { name: 'Matematica', pct: 92 },
    { name: 'Portugues', pct: 85 },
    { name: 'Biologia', pct: 78 },
    { name: 'Historia', pct: 70 },
  ];
  return (
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-white border-b" style={{ borderColor: '#e9d5ff', boxShadow: '0 1px 12px rgba(124,58,237,0.08)' }}>
        <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/pricing" className="font-medium transition-colors text-sm" style={{ color: '#6b7280' }}>Preos</Link>
            <Link href="/login" className="text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 shadow-md hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg, #7c3aed, #9333ea)' }}>Comecar Gratis</Link>
          </div>
        </div>
      </nav>
        ...
        <section className="relative overflow-hidden" style={{ background: 'linear-gradient(160deg, #ffffff 0%, #faf5ff 50%, #f3e8ff 100%)' }}>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 md:py-28 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight" style={{ color: '#1e1b4b' }}>
              ...
              <span style={{ background: 'linear-gradient(135deg, #7c3aed, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Inteligencia Artificial</span>
            </h1>
            <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed" style={{ color: '#6b7280' }}>
              Prepare-se para ENEM, OAB, Concursos Publicos e CPA-20 com IA que aprende com voce e maximiza seus resultados.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
              {[
                { icon: 'u{1F393}', title: 'Conteudo Claro', sub: 'Objetivo e direto ao ponto' },
                { icon: 'u{1F916}', title: 'IA Adaptativa', sub: 'Aprende com seu ritmo' },
                { icon: 'u{1F3AF}', title: 'Foco no Resultado', sub: 'Maximiza sua aprovacao' },
              ].map((item, i) => (
          ...
          <div className="max-w-5xl mx-auto px-6 py-14">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                { label: 'Taxa de Aprovacao', target: 95, suffix: '%' },
                { label: 'Questoes Disponiveis', target: 1000, suffix: '+' },
                { label: 'Disponivel', target: 24, suffix: '/7' },
              ].map((stat, i) => (
        ...
        <section className="py-20" style={{ background: '#ffffff' }}>
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mb-3" style={{ color: '#1e1b4b' }}>Acompanhe cada passo da sua evolucao</h2>
              <p className="max-w-xl mx-auto" style={{ color: '#6b7280' }}>Dashboards com graficos e insights personalizados pela IA</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="rounded-2xl p-6 border hover:-translate-y-1 transition-all duration-300" style={{ background: '#fafafa', borderColor: '#ede9fe', boxShadow: '0 4px 20px rgba(124,58,237,0.06)' }}>
                <div className="flex items-center justify-between mb-5">
                  <div><h3 className="font-bold text-sm" style={{ color: '#1e1b4b' }}>Evolucao de Acertos</h3><p className="text-xs mt-0.5" style={{ color: '#9ca3af' }}>Ultimos 6 meses</p></div>
              ...
              <div className="rounded-2xl p-6 border hover:-translate-y-1 transition-all duration-300" style={{ background: '#fafafa', borderColor: '#ede9fe', boxShadow: '0 4px 20px rgba(124,58,237,0.06)' }}>
                <div className="mb-5"><h3 className="font-bold text-sm" style={{ color: '#1e1b4b' }}>Materias em Destaque</h3><p className="text-xs mt-0.5" style={{ color: '#9ca3af' }}>Taxa de acerto por disciplina</p></div>
                <MateriasChart />
              </div>
            </div>
          </div>
        ...
        <section className="py-20" style={{ background: '#faf5ff' }}>
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mb-3" style={{ color: '#1e1b4b' }}>Tudo que voce precisa para passar</h2>
              <p style={{ color: '#6b7280' }}>Ferramentas inteligentes para maximizar sua aprovacao</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { icon: 'A', bg: '#f3e8ff', iconBg: '#7c3aed', title: 'IA Inteligente', desc: 'Assistente powered by Gemini AI que aprende com seu estilo de estudo e se adapta as suas necessidades.' },
                { icon: 'B', bg: '#ede9fe', iconBg: '#6d28d9', title: 'Progresso em Tempo Real', desc: 'Metricas detalhadas, relatorios e metas personalizadas geradas pela inteligencia artificial.' },
                { icon: 'C', bg: '#faf5ff', iconBg: '#9333ea', title: 'Foco no Resultado', desc: 'Simulados, questoes e planos de estudo otimizados para maximizar suas chances de aprovacao.' },
              ].map((feature, i) => (
                <div key={i} className="rounded-2xl p-8 border hover:-translate-y-2 transition-all duration-300 group cursor-default" style={{ background: feature.bg, borderColor: '#e9d5ff', boxShadow: '0 2px 16px rgba(124,58,237,0.05)' }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl mb-5 shadow-sm font-bold text-white" style={{ background: feature.iconBg }}>{feature.icon}</div>
        ...
        <section className="py-16" style={{ background: '#ffffff' }}>
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-extrabold mb-2" style={{ color: '#1e1b4b' }}>Para qual prova voce esta se preparando?</h2>
              <p className="text-sm" style={{ color: '#9ca3af' }}>Conteudo 100% alinhado com as bancas mais exigentes do Brasil</p>
            </div>
        ...
        <section className="py-20" style={{ background: 'linear-gradient(160deg, #faf5ff 0%, #f3e8ff 100%)' }}>
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mb-3" style={{ color: '#1e1b4b' }}>Simples. Rapido. Eficaz.</h2>
              <p style={{ color: '#6b7280' }}>Comece em minutos e sinta a diferenca desde a primeira sessao</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { step: '01', icon: '1', title: 'Crie sua conta', desc: 'Cadastre-se gratuitamente em segundos. Sem cartao de credito necessario.' },
                { step: '02', icon: '2', title: 'A IA te conhece', desc: 'Nossa IA analisa seu nivel e cria um plano de estudo personalizado.' },
                { step: '03', icon: '3', title: 'Tire 10', desc: 'Pratique com questoes inteligentes e simulados com feedback instantaneo.' },
              ].map((item, i) => (
                <div key={i} className="text-center">
                  <div className="rounded-2xl p-8 border bg-white hover:-translate-y-1 transition-all duration-200" style={{ borderColor: '#e9d5ff', boxShadow: '0 4px 24px rgba(124,58,237,0.07)' }}>
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl text-2xl font-extrabold mb-5 shadow-md text-white" style={{ background: 'linear-gradient(135deg, #7c3aed, #a855f7)' }}>{item.icon}</div>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="rounded-3xl p-12 md:p-16 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #5b21b6, #7c3aed, #9333ea)', boxShadow: '0 20px 60px rgba(109,40,217,0.3)' }}>
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg mb-8 max-w-xl mx-auto" style={{ color: '#ede9fe' }}>Mais de 50 mil alunos ja aprovados. Acesso gratuito, sem cartao de credito.</p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/login" className="inline-flex items-center justify-center bg-white px-10 py-4 rounded-2xl text-base font-bold transition-all duration-200 shadow-xl hover:-translate-y-1" style={{ color: '#7c3aed' }}>Comecar Gratuitamente</Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm" style={{ color: '#475569' }}>
              ...
              <Link href="/politicas" className="hover:text-purple-400 transition-colors">Politicas</Link>
