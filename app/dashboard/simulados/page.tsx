...
const vestibularSimulados: SimuladoConfig[] = [
  {
    ...
    timeMinutes: 330,
    difficulty: 'Médio',
    areas: ['Linguagens', 'Ciências Humanas', 'Redação'],
    areaOrder: [
      { area: 'Português', count: 13 },
      { area: 'Inglês', count: 5 },
      { area: 'Espanhol', count: 2 },
      { area: 'História', count: 12 },
      { area: 'Geografia', count: 8 },
      { area: 'Redação', count: 5 },
    ],
    color: 'blue',
    tag: 'ENEM',
  ...
  },
  {
    ...
    areaOrder: [
      ...
      { area: 'Física', count: 10 },
      { area: 'Química', count: 10 },
      { area: 'Matemática', count: 15 },
    ],
    color: 'indigo',
    tag: 'ENEM',
  ...
  },
  {
    ...
    areaOrder: [
      { area: 'Português', count: 12 },
      { area: 'História', count: 8 },
      { area: 'Geografia', count: 5 },
      { area: 'Biologia', count: 6 },
      { area: 'Química', count: 6 },
      { area: 'Física', count: 5 },
      { area: 'Matemática', count: 3 },
    ],
    color: 'purple',
    tag: 'FUVEST',
  ...
  },
  {
    ...
    areaOrder: [
      { area: 'Português', count: 15 },
      { area: 'Matemática', count: 15 },
      { area: 'História', count: 10 },
  ...
  },
  {
    ...
    areaOrder: [
      { area: 'Português', count: 12 },
      { area: 'História', count: 8 },
      { area: 'Matemática', count: 10 },
      { area: 'Biologia', count: 5 },
      { area: 'Química', count: 5 },
      { area: 'Física', count: 5 },
    ],
    color: 'teal',
    tag: 'UNICAMP',
  ...
  },
  {
    ...
    areaOrder: [
      ...
      { area: 'Matemática Financeira', count: 10 },
      { area: 'Finanças Pessoais', count: 5 },
    ],
    color: 'yellow',
    tag: 'Finanças',
  ...
  },
  {
    ...
    areaOrder: [
      ...
      { area: 'Química', count: 12 },
      { area: 'Física', count: 10 },
      { area: 'Matemática', count: 5 },
      { area: 'Português', count: 3 },
    ],
    color: 'red',
    tag: 'Medicina',
  ...
  },
  {
    ...
    areaOrder: [
      { area: 'Matemática', count: 15 },
      { area: 'Física', count: 10 },
      { area: 'Química', count: 8 },
      { area: 'Português', count: 10 },
      { area: 'História', count: 4 },
