...
<div className="mb-4">
<label htmlFor="area-select" className="block text-sm font-medium text-gray-700 mb-2">ÁREA</label>
<select
id="area-select"
value={selectedArea}
...
<div className="mb-4">
<label htmlFor="difficulty-select" className="block text-sm font-medium text-gray-700 mb-2">DIFICULDADE</label>
<select
...
cls += 'border-gray-200 text-gray-400 cursor-not-allowed';
}
} else {
...
disabled={showResult}
>
<span className="font-semibold mr-2">{String.fromCodePoint(65 + idx)}.</span> {opt}
</button>
);
})}
</div>
