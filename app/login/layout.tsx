...
export const metadata: Metadata = {
    ...
    description: 'Acesse sua conta Tirei10 ou cadastre-se gratuitamente para estudar com IA para ENEM, OAB, Concursos Públicos e CPA ANBIMA. Login rápido com Google.',
    alternates: {
