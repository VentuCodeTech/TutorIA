...
// Mapeamento de areas para subjects do banco (normalizado)
...
// Banco de questoes expandido - ENEM, FUVEST, UNICAMP, OAB, CPA-20, Concursos (atualizado 2025)
const questionBank = [
  // ===================== MATEMATICA =====================
  ...
  { subject: 'Portugues', difficulty: 'Facil', text: '(ENEM 2025) Em qual alternativa ha crase obrigatoria?', options: ['Ela foi a escola.', 'Vou a Paris.', 'Refiro-me a ela.', 'Voou a 300km/h.'], correctAnswer: 0, explanation: 'Crase ocorre antes de feminino: "a escola" (Artigo+preposicao). Paris nao tem artigo. "ela" nao e feminino que aceita artigo.' },
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Tentar gerar via Gemini AI primeiro
    try {
