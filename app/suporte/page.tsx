        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 text-center">
              ...
              <a href="mailto:suporte@tutoria.app" className="text-indigo-600 hover:underline text-sm font-medium">suporte@tutoria.app</a>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100 text-center">
              <div className="text-4xl mb-3">💬</div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100 mb-8">
            ...
            <div className="space-y-6">
              {[
                {
                  q: 'Como criar uma conta no TutorIA?',
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 text-center text-white">
            ...
            <a href="mailto:suporte@tutoria.app" className="bg-white text-indigo-600 px-8 py-3 rounded-xl font-bold hover:bg-indigo-50 transition-colors inline-block">
              Enviar Email →
            </a>
          </div>
        </div>
